...
<p align="center"> <img src="Pictures/Figure_Longitudinal_motion_2.png" width="500">
...
The longitudinal tire forces $F_{xf}$ and $F_{xr}$ are friction forces from the ground that act on the tires. (TODO: describe it above)
...
- comes from a portion of the weight of the vehicle;
- is influenced by fore-aft location of the c.g., vehicle longitudinal acceleration, aerodynamic drag forces and grade of the road.
...
<p align="center"> <img src="Pictures/Figure_Lateral_motion_1.png" width="500"></p>
